...
![](https://i-blog.csdnimg.cn/direct/12dfd98d2386491a806c03aa421764e3.png)
...
![](https://i-blog.csdnimg.cn/direct/63f85f24007a49b3bc0990d65f459c99.png)
下面附上代码：
```cpp
//空栈递增
...
```
空栈递增：
![](https://i-blog.csdnimg.cn/direct/395a6d82d0ea47c19fa7d4d87f6dc804.png)
——————————————————————————————————————————
```cpp
//满栈递增
pos++;//先更新pos指向位置
...
```
满栈递增：
![](https://i-blog.csdnimg.cn/direct/4bab309574c24247b26ed9d2bdda272c.png)
———————————————————————————————————————————
```cpp
//空栈递减
...
```
空栈递减：
![](https://i-blog.csdnimg.cn/direct/64c706dd95af42b1a92327e8e2daa3b3.png)
———————————————————————————————————————————
```cpp
//满栈递减
pos--;//先更新指向
...
```
满栈递减：
![](https://i-blog.csdnimg.cn/direct/9649a2ce9aa04747b460ba807e89ed00.png)
...
下面是一个概念图：
![](https://i-blog.csdnimg.cn/direct/b5c405a543aa4f4bb8529dbaae71900e.png)
由此，模仿链式结构，我们可以实现链式栈：
1、头文件.h文件的编写：
```cpp
typedef int Element;
