...
————————————本栏目旨在讨论计算机知识，欢迎交流—————————————![](https://i-blog.csdnimg.cn/direct/7ac0801cf8d146ffaa33e09a5a20e413.png)
上一章，我们讨论了顺序栈和链式栈，这一章，我们将讲解线性结构的最后一个部分——顺序队列和链式队列。相比于栈结构的同端进出，就像原肠生物，而队列则是尾部入队和头部出队，就像后口生物一样。
如图：
![](https://i-blog.csdnimg.cn/direct/c56a83cc0070429093526fe768ade121.png)
那么，如何来实现入队和出队呢？答曰：请看VCR：
![](https://i-blog.csdnimg.cn/direct/ed61e56b2204441b89e567c554c1e15f.png)
...
![](https://i-blog.csdnimg.cn/direct/e10607542d2c40e1b2aea48565176976.png)
下面，我们来通过代码实现它：
1、首先是.h文件功能实现的构建：
```cpp
#ifndef LINK_QUEUE_H
