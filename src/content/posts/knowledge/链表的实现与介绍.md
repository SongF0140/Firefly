...
![](https://i-blog.csdnimg.cn/direct/8033999c68dc47599a69214803d79dd2.png)
于是，我们这时候需要一种新的结构去存储，来避免这种空间浪费的情况，链式存储结构应运而生：
![](https://i-blog.csdnimg.cn/direct/1048bf2596d5456fb576dc3e0c61a300.png)
这样，我们就能理论上节约内存了；
![](https://i-blog.csdnimg.cn/direct/8a099716a5d2454b9f4dfec0b0704c3e.png)
![](https://i-blog.csdnimg.cn/direct/d7ebf0e37abc4df0b89b1e04ad33c3c1.png)
（PS: 事实上，由于操作系统的存在，我们存储的只是在虚拟内存上，而它真实的内存其实映射到我们的物理内存上并非是如此的，于是对于顺序表操作系统给我们分配的物理内存其实并非真正连续的，我们这里讨论的其实只是无操作系统下关于内存的合理化分配）
下面，我们来详细讲讲关于链表的知识：
首先我们给出链表的图形化结构：
![](https://i-blog.csdnimg.cn/direct/5db42e440ffd4abe9bc7728e10e0d25e.png)
...
![](https://i-blog.csdnimg.cn/direct/00f03f086baf4244a3e1ada5a6392414.png)
...
```
（三） 头插法
![](https://i-blog.csdnimg.cn/direct/2e2f0e5f4bfb4895a6b476397b18f037.png)
```cpp
